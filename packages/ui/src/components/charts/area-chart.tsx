...
import type { LineConfig, Margin } from './engine/chart-context';
import {
  type ChartPhase,
  type ChartStatus,
...
} from './engine/chart-phase';
import { TimeSeriesChartInner } from './engine/time-series-chart-shell';
import { ChartLoadingLabel } from './loading/chart-loading-label';
import { PatternArea } from './overlays/pattern-area';
...
function ChartInner({
  ...
  const clipPathId = `chart-area-grow-clip-${useId().replace(/[^a-zA-Z0-9]/g, '')}`;
