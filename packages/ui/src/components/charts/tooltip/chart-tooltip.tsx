...
import { resolveTooltipBoxMotion, type SpringConfig, useChartConfig } from '../engine/chart-config-context';
import { chartCssVars, type LineConfig, useChart, useChartStable } from '../engine/chart-context';
import { weekdayDateFmt } from '../engine/chart-formatters';
import type { IndicatorFadeEdges } from '../engine/indicator-fade';
...
export interface ChartTooltipProps {
  ...
  /** Custom title for the hovered point. Default: weekday and date, or the bar category. */
...
const ChartTooltipInner = memo(function ChartTooltipInner({
  ...
  const title = useMemo(() => {
    ...
    if (titleRenderer) {
      return titleRenderer(tooltipData.point, tooltipData.index);
    }
  ...
  }, [tooltipData, barXAccessor, xAccessor, titleRenderer]);
