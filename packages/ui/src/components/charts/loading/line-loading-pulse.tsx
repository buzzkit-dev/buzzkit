...
import { chartCssVars, useChartStable } from '../engine/chart-context';
import type { ChartPhase } from '../engine/chart-phase';
import { fadeGradientStops, resolveFadeSides, viewportFadeGradientAttrs } from '../series/fade-edges';
