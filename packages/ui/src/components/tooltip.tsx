    ...
    <TooltipPrimitive.Portal>
      ...
      >
        ...
        <TooltipPrimitive.Popup
          ...
          className={cn(
            'corner-superellipse/1.125 data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=delayed-open]:fade-in-0 data-[state=delayed-open]:zoom-in-95 data-open:fade-in-0 data-open:zoom-in-95 data-closed:fade-out-0 data-closed:zoom-out-95 z-50 inline-flex min-h-6 w-fit max-w-xs origin-(--transform-origin) items-center gap-1.5 rounded-lg bg-fg-4 px-2.5 py-1 font-medium text-background text-xs shadow-sm has-data-[slot=kbd]:py-0.5 has-data-[slot=kbd]:pr-0.5 data-[state=delayed-open]:animate-in data-closed:animate-out data-open:animate-in **:data-[slot=kbd]:relative **:data-[slot=kbd]:isolate **:data-[slot=kbd]:z-50 **:data-[slot=kbd]:h-5 **:data-[slot=kbd]:rounded-md **:data-[slot=kbd]:bg-background/15 **:data-[slot=kbd]:text-background',
            className
          )}
          {...props}
        >
