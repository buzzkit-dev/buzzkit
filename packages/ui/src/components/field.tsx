...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        'mb-1.5 font-medium text-fg-4 leading-tighter data-[variant=label]:text-sm data-[variant=legend]:text-base',
        className
      )}
      {...props}
    />
...
const fieldVariants = cva('group/field flex w-full gap-2 data-[invalid=true]:text-red-text', {
  variants: {
    orientation: {
...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: a fieldset can't flex its children reliably; FieldSet covers the semantic case
    <div
      role='group'
      data-slot='field'
...
function FieldContent({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('group/field-content flex flex-1 flex-col leading-tighter', className)}
      {...props}
    />
  );
}
...
function FieldTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot='field-label'
      className={cn(
        'flex w-fit items-center gap-2 font-medium text-sm leading-tighter group-data-[disabled=true]/field:opacity-50',
        className
      )}
      {...props}
    />
...
function FieldSeparator({
  ...
  return (
    ...
    >
      ...
      {children && (
        <span
          className='relative mx-auto block w-fit bg-bg-1 px-2 text-fg-2'
...
function FieldError({
  ...
  return (
    <div role='alert' data-slot='field-error' className={cn('text-red-text text-sm', className)} {...props}>
      {content}
    </div>
  );
}
