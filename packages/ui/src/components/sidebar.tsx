...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from '@buzzkit/ui/components/sheet';
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: upstream shadcn persistence — a plain client-readable preference cookie
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <Icon name='IconSidebar' className='size-4' />
