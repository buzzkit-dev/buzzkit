...
In the dashboard both live under **Settings → Channels → Identity verification** for the selected tenant: the switch enforces it, and the secret can be revealed, copied and rotated there.
