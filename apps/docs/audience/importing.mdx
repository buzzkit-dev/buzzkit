...
The import runs in batches with a progress bar and finishes with a summary: how many subscribers are new, how many subscriptions were written, and how many rows the API refused.
