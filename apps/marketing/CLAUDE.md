...
- **Motion.** `motion/react` springs at `bounce: 0`, `AnimatePresence initial={false}` except the hero stacks' first paint, reduced motion freezes every loop. No entrance choreography on sections.
