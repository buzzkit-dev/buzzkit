...
│                         events: actor flushes → gzipped Events API batches, `buzzkit-events-dlq` re-driven into the main queue) and the reconciliation cron
