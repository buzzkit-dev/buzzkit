/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 41671fea4e41ad2b7b3843c8ab6bba71)
// Runtime types generated with workerd@1.20260831.1 2025-06-01 nodejs_compat
interface __BaseEnv_Env {
	KEYS: KVNamespace;
	ENVIRONMENT: "production";
	BUZZKIT_API_URL: "https://api.buzzkit.dev";
	BUZZKIT_PUBLISHABLE_KEY: "bk_pk_UJ7Xm7l4uEE2mH4WYnfOb4dxjwR1XvSGs53pxjM9";
	BUZZ_URL: "https://buzzkit.dev/buzz";
	BUZZKIT_API_KEY: string;
	BUZZKIT_IDENTITY_SECRET: string;
	PING_URL: string;
	DEVICE: DurableObjectNamespace<import("./src/index").DeviceState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DeviceState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "BUZZKIT_API_URL" | "BUZZKIT_PUBLISHABLE_KEY" | "BUZZ_URL" | "BUZZKIT_API_KEY" | "BUZZKIT_IDENTITY_SECRET" | "PING_URL">> {}
}
