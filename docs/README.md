...
- api/ — one file per API resource: [health](api/health.md), [workspaces](api/workspaces.md), [tenants](api/tenants.md), [keys](api/keys.md), [credentials](api/credentials.md), [events](api/events.md), [subscribers](api/subscribers.md), [topics](api/topics.md), [client](api/client.md)
