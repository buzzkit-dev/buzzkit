...
- Additional channels (email, SMS, web push) as connectors — the Phase 5 provider interface and Phase 7/8 channel-generic specs are the preparation; building them waits until push is excellent.
